...
class TestUkWorkingDays < Test::Unit::TestCase
  context "Region GB" do
    setup { UkWorkingDays.region = 'GB' }
    ...
    context "new years day holiday" do
       should "return new year's day if it is a weekday" do
         assert_includes Date.public_holidays(2010), Date.new(2010, 1, 1)
       end

       should "return the next monday after new year's day if on a weekend" do
         assert_includes Date.public_holidays(2011), Date.new(2011, 1, 3)
       end
     end

     context "christmas day holiday" do
       should "return christmas day if it is a weekday" do
         assert_includes Date.public_holidays(2009), Date.new(2009, 12, 25)
       end

       should "return the next monday after new year's day if on a weekend" do
         assert_includes Date.public_holidays(2010), Date.new(2010, 12, 27)
       end
     end

     context "boxing day holiday" do
       should "return following monday if boxing day is on saturday" do
         assert_includes Date.public_holidays(2009), Date.new(2009, 12, 28)
       end

       should "return the following tuesday if boxing day is on sunday" do
         assert_includes Date.public_holidays(2010), Date.new(2010, 12, 28)
       end

       should "return the following tuesday if boxing day is on monday" do
         assert_includes Date.public_holidays(2011), Date.new(2011, 12, 27)
       end

       should "return boxing day itself in other cases" do
         assert_includes Date.public_holidays(2008), Date.new(2008, 12, 26)
       end
     end

     context "easter monday" do
       should "return the monday after easter" do
         assert_includes Date.public_holidays(2010), Date.new(2010, 4, 5)
       end
     end

     context "good friday" do
       should "return the friday before easter sunday" do
         assert_includes Date.public_holidays(2010), Date.new(2010, 4, 2)
       end
     end

     context "may bank holiday" do
       should "return the first monday in may" do
         assert_includes Date.public_holidays(2010), Date.new(2010, 5, 3)
       end
     end

     context "spring bank holiday" do
       should "return the last monday in may" do
         assert_includes Date.public_holidays(2010), Date.new(2010, 5, 31)
       end
     end

     context "summer bank holiday" do
       should "return the last monday in august" do
         assert_includes Date.public_holidays(2010), Date.new(2010, 8, 30)
       end
     end
